...
SYSTEM_V1 = (
    "Bạn là trợ lý AI thân thiện. Trả lời ngắn gọn, rõ ràng (2-4 câu) chỉ dựa trên "
    "context được cung cấp bên dưới. Nếu không có thông tin, hãy nói thẳng là không biết."
    "\n\nContext:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin. Đọc kỹ context được cung cấp, xác định các "
    "fact liên quan, sau đó viết câu trả lời rõ ràng, có cấu trúc (3-5 câu): tóm tắt ý "
    "chính, trích dẫn thông tin từ context, và nêu mức độ chắc chắn. Luôn dựa trên "
    "context, không suy đoán thêm.\n\nContext:\n{context}"
)
...
def run_ragas_eval(rag_results: list, version: str) -> dict:
    ...
    # Ollama local chỉ chạy 1 model tuần tự → giảm max_workers để tránh nghẽn hàng đợi
    # gây timeout hàng loạt, và tăng timeout vì model local sinh chậm hơn API cloud.
